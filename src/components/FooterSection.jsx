        ...
        <footer className="bg-green-200 flex justify-between px-10 pt-5 pb-3 gap-10">
            <section className="flex-1/2">
                ...
                <div className="flex items-center gap-5 mt-5">
                    <a className="px-3 py-1 rounded-lg bg-green-950 text-white" href="">F</a>
                    <a className="px-3 py-1 rounded-lg bg-green-950 text-white" href="">T</a>
                    <a className="px-3 py-1 rounded-lg bg-green-950 text-white" href="">in</a>
                </div>
            </section>
