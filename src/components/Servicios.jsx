    ...
    return(
        <section className="division flex gap-4">
            ...
            <div className="flex-1/2 py-2 px-4">
                <span className="inline-flex gap-2 items-center justify-center px-4 py-2 border text-sm rounded-lg border border-fuchsia-400/50 bg-gradient-to-l from-violet-400/30 from-25% via-fuchsia-400/30 via-100% text-fuchsia-800 font-semibold"> <PcIc /> Nuestros Servicios</span>
