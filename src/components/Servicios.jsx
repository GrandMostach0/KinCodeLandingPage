    ...
    return(
        <section className="division flex gap-4">
            ...
            <div className="flex-1/2 py-2 px-4">
                ...
                <h1 className="font-bold text-4xl">Soluciones Web Completas</h1>
                
                <p className="py-2 text-lg">Ofrecemos servicios integrales de desarrollo web, desde la conceptualización hasta el lanzamiento y mantenimiento. Tu éxito digital es nuestra prioridad.</p>
