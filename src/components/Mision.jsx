    ...
    return(
        <section className="division">
            <div className="borde text-center flex flex-col items-center justify-center gap-2">
                ...
                <p className="w-[70%] text-base font-semibold">Somos un equipo apasionado de desarrolladores y diseñadores que crea soluciones web innovadoras. Combinamos creatividad, tecnología de vanguardia y experiencia de usuario excepcional para llevar tu negocio al siguiente nivel digital.</p>
            </div>
